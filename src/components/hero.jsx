                ...
                <nav className="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
                    <div className="flex lg:flex-1">
                        <a href="#" className="-m-1.5 p-1.5">
                            ...
                            <img className="h-16 w-auto" src="/images/ExpiProjectCircle.png" alt="Logo"/>
                        </a>
                    </div>
            ...
            <div className="relative isolate px-6 pt-14 lg:px-8">
                ...
                <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
                    ...
                    <div className="text-center">
                        <h1 className="text-5xl font-semibold tracking-tight text-balance text-gray-100 sm:text-7xl">Expi Project</h1>
                        <br/>
                        ...
                        <div className="mt-10 flex items-center justify-center gap-x-6">
                            ...
                            <a href="https://saweria.co/MrYapikZ"
                               className="rounded-md border-gray-300 px-3.5 py-2.5 text-sm font-semibold text-white border">Donate Us <span
